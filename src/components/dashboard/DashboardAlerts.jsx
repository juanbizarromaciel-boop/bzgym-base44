...
export default function DashboardAlerts({ alerts, financialTotal = 0 }) {
  ...
  return (
    <section className="grid grid-cols-2 gap-2.5">
      <div className="h-[138px] rounded-[18px] border border-amber-400/15 bg-professor-card/75 p-3 backdrop-blur-md">
      ...
      <div className="h-[138px] rounded-[18px] border border-emerald-400/15 bg-professor-card/75 p-3 backdrop-blur-md">
        ...
        <Link to="/Finance" className="mt-3 flex min-h-7 items-center justify-between text-[10px] text-emerald-300">Ver relatórios <ChevronRight className="h-3.5 w-3.5" /></Link>
      </div>
    </section>
  );
}